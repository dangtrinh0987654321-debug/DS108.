...
> |---|---|
> | `RAW/` | Dữ liệu thô crawl từ Tiki (`dataset.csv`, ~719k records) |
> | `CLEANED/` | `train_clean.csv`, `val_clean.csv`, `test_clean.csv` (584k records) |
> | `FEATURE/` | `train_merged_features.csv`, `val_merged_features.csv`, `test_merged_features.csv` |
...
.
├── data/
│   ├── sample_raw_data.csv                # ← SAMPLE dữ liệu thô (GitHub only)
│   ├── sample_clean_data.csv              # ← SAMPLE dữ liệu đã làm sạch (GitHub only)
│   └── .gitkeep
│
├── notebooks/
│   ├── 1_Data_Collection.ipynb
│   ├── 2_EDA_For_Preprocessing.ipynb
│   ├── 3_Data_Cleaning_&_Validation.ipynb
│   ├── 4_Feature_Engineering_&_EDA.ipynb
│   ├── 5_Merge.ipynb
│   ├── 6_Labelling_&_Validation.ipynb
│   └── .gitkeep
│
├── .gitignore
├── requirements.txt
...
> 📁 **Dữ liệu đầy đủ** (raw, cleaned, features, labelled) được lưu trên Google Drive.
...
**File:** `notebooks/1_Data_Collection.ipynb`  
...
**File:** `notebooks/2_EDA_For_Preprocessing.ipynb`  
...
**File:** `notebooks/3_Data_Cleaning_&_Validation.ipynb`  
...
**File:** `notebooks/4_Feature_Engineering_&_EDA.ipynb`  
...
**File:** `notebooks/6_Labelling_&_Validation.ipynb`  
...
> ⚠️ **Quan trọng:** Các cột `B_score`, `C_score`, `A_score`, `suspicious_score` là output của quá trình gán nhãn. **Không dùng các cột này làm input cho mô hình** – sẽ gây label-feature circularity và inflate performance giả tạo. Các cột tham gia vào quá trình Labelling cũng cần loại bỏ trước khi đánh giá trên mô hình học máy.
